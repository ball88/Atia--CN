...
#import "ARIEditingView.h"
#import "ARISettingsCollectionViewHost.h"
#import "../Manager/ARIEditManager.h"
#import "../Manager/ARITweak.h"
...
- (void)updateIsSingleListView {
    ...
    if([ARIEditManager sharedInstance].singleListMode) {
        // Single list mode
        ARITweak *manager = [ARITweak sharedInstance];
        self.perPageIndicator.text = [NSString stringWithFormat:@"仅此页面 (%lu)", [manager indexOfListView:[[ARIEditManager sharedInstance] currentIconListViewIfSinglePage]]];
